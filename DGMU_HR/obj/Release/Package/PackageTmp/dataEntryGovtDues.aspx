<%@ Page Title="" Language="C#" MasterPageFile="~/HRMS.Master"  AutoEventWireup="true" CodeBehind="dataEntryGovtDues.aspx.cs" Inherits="DGMU_HR.dataEntryGovtDues" %>
...
<asp:UpdatePanel runat="server" ID="uplMain">
  ...
  <div class="panel panel-warning">
    <div class="panel-heading">
                ...
                <h5><span class="glyphicon glyphicon-cog"></span> Manual Entry of Gov't Dues <asp:Label runat="server" ID="lblFY"></asp:Label></h5>
    ...
    <div class="panel-body">
       ...
       <!-- Search Area -->
         <div class="col-md-3">
             ...
             <asp:DropDownList runat="server" ID="ddCompanies" CssClass="dropdown form-control" />
             <br />
        ...
        <div class="col-md-3">
             <div class="input-group">
             <asp:DropDownList runat="server" ID="ddMonths" CssClass="dropdown form-control" />
                  <div class="input-group-btn input-group-sm">
                        <asp:LinkButton runat="server" ID="lnkSet" CssClass="btn btn-primary" OnClick="lnkSet_Click"><span class="glyphicon glyphicon-search"></span> SET</asp:LinkButton>
                    </div>
                 </div>
        </div>
        <div class="col-md-3 col-md-offset-3 text-right">
            <asp:LinkButton runat="server" ID="lnkSave" CssClass="btn btn-primary" OnClick="lnkSave_Click"><span class="glyphicon glyphicon-saved"></span> Process and Save All</asp:LinkButton>
        </div>
        <div class="col-md-12">
            ...
            <asp:Panel runat="server" ID="panelEmployeeList" Height="550px" ScrollBars="Vertical">
                <asp:GridView runat="server" ID="gvEmployeeList"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="BasicRate" HeaderText ="Basic Rate" DataFormatString="{0:n}" />
                       
                         <asp:TemplateField ItemStyle-CssClass="text-center" HeaderText="Days Present" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                
                               <asp:TextBox runat="server" ID="txtDaysPresent" CssClass="form-control" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="BillingCompany" HeaderText ="Company To Bill"/>
                          
                        <asp:TemplateField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" HeaderText="SSS" ControlStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblSSSPay" Text='<%# string.Format("{0:n}", Eval("SSS_EE"))%>' ></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>

                         <asp:TemplateField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" HeaderText="PHIL HEALTH" ControlStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblPHPay" Text='<%# string.Format("{0:n}", Eval("PH_EE"))%>' ></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>

                         <asp:TemplateField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" HeaderText="HDMF" ControlStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblHDMFPay" Text='<%# string.Format("{0:n}", Eval("HDMF_EE"))%>' ></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        
                       <%-- <asp:BoundField DataField="SSS" HeaderText ="SSS" DataFormatString="{0:n}" />
                         <asp:BoundField DataField="PH" HeaderText ="PHIL HEALTH" DataFormatString="{0:n}" />
                         <asp:BoundField DataField="HDMF" HeaderText ="HDMF" DataFormatString="{0:n}" />--%>
                   <%--     <asp:TemplateField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" HeaderText="Basic Monthly Rate" ControlStyle-CssClass="text-center">
                        ...
                        <asp:TemplateField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" HeaderText="Control" ControlStyle-CssClass="text-center">
                            <ItemTemplate>
                               <asp:LinkButton runat="server" ID="lnkProcessIndividual" CssClass="btn btn-primary" CommandName="SAVE"><span class="glyphicon glyphicon-floppy-save"></span> Process & Save</asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
