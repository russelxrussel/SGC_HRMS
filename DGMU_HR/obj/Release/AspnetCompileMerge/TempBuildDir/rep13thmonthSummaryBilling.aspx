<%@ Page Title="" Language="C#" MasterPageFile="~/HRMS.Master" AutoEventWireup="true" CodeBehind="rep13thmonthSummaryBilling.aspx.cs" Inherits="DGMU_HR.rep13thmonthSummaryBilling" %>
     ...
     <div class="row">
      <div class="col-md-3 hidden">
             <ul class="list-group">
                ...
                <li class="list-group-item">
                        <div class="input-group input-group-sm">
                     <span class="input-group-addon alert-danger">Date Display in Report</span>
                         <asp:TextBox ID="txtDateDisplay" runat="server" CssClass="form-control calendarInput"></asp:TextBox>
                         </div>
                </li>
                 <li class="list-group-item">
