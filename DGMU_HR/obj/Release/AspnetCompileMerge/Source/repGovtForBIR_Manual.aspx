<%@ Page Title="" Language="C#" MasterPageFile="~/HRMS.Master" AutoEventWireup="true" CodeBehind="repGovtForBIR_Manual.aspx.cs" Inherits="DGMU_HR.repGovtForBIR_Manual" %>
             ...
             <ul class="list-group">
                 <li class="list-group-item">
                     <div class="input-group input-group-sm">
                         ...
                         <asp:DropDownList runat="server" ID="ddMonths" CssClass="form-control"></asp:DropDownList>
